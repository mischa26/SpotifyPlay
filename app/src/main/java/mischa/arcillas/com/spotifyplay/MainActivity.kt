...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (checkSelfPermission(applicationContext, android.Manifest.permission.READ_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {
            ...
            while (songCursor != null && songCursor.moveToNext()) {
                ...
                mySong.add(Song(songName, album, media_path))
        ...
        var pauseRes = R.drawable.ic_pause_black_24dp

        var pauseORplay = findViewById<ImageView>(R.id.playPause_btn)
        var currentButtonHolder = R.drawable.ic_pause_black_24dp
